...
# 📖 Meme Generator <a name="about-project"></a>

- This is a simple React meme generator application with a simple UI that returns a random image requested from an API upon button's click, combined with the text that the user will type in the input boxes generating the meme picture with the text on the top & bottom of it.
